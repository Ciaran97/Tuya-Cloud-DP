...
STEP1_SCHEMA = vol.Schema({
    ...
    vol.Required(CONF_USER_CODE): str,  # like official: user supplies the app user_code
})
...
class TuyaCloudDPConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(self, user_input=None) -> FlowResult:
        ...
        try:
            ...
            # cache creds for next step
            self.hass.data.setdefault(DOMAIN, {})["seed"] = self._cfg1
